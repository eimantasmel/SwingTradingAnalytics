 ...
 * 
 */
class ShitcoinStrategy implements SwingTradingStrategyInterface
{
    ...
    private const MAX_VOLUME = 300_000;
    ...
    private const PYRAMIDING_TRADES_AMOUNT = 20;
    ...
    private function isSecurityEligibleForTrading(array $lastCandleSticks, Security $security, string $position) : bool
    {
        ...
        if($volume < self::MIN_VOLUME || $volume > self::MAX_VOLUME)
            return false;
        ...
        if($closePrice < $sma200 && $closePrice > 0 && $atr14 / $closePrice >= 0.05)
        {
