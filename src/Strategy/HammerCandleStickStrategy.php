 ...
 * 
 */
class HammerCandleStickStrategy implements SwingTradingStrategyInterface
{
    ...
    private function isSecurityEligibleForTrading(array $lastCandleSticks, Security $security) : bool
    {
        ...
        if($this->technicalIndicatorsService->isBullishEngulfingPattern($lastCandleSticks)
            || $this->technicalIndicatorsService->isCandleStickHammer($lastCandleStick, $atr14)
          )
        {
        ...
        if($this->technicalIndicatorsService->isBearishEngulfingPattern($lastCandleSticks)
            || $this->technicalIndicatorsService->isCandleStickHangingMan($lastCandleStick, $atr14)
          )
        {
