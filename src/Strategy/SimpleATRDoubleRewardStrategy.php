 ...
 * 
 */
class SimpleATRDoubleRewardStrategy implements SwingTradingStrategyInterface
{
    ...
    private const TARGET_PERCENTAGE = 2;      // Target is 200 percent from the stop loss
