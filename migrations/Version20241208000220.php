 ...
 */
final class Version20241208000220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Securities (id INT AUTO_INCREMENT NOT NULL, ticker VARCHAR(20) NOT NULL, is_crypto TINYINT(1) DEFAULT NULL, is_forex TINYINT(1) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
